...
state_pop = pd.read_csv('C:/Users/me/Documents/lookatnum-com/src/covid-map/Untitled spreadsheet - Sheet1.csv')
...
old_deaths = all_deaths[all_deaths['date'] == '2021-07-15']
...
state_pop = state_pop.filter(['State', 'fips', 'cases', 'deaths', 'pop', 'recent_deaths', 'ratio', 'vs_overall'], axis=1)
